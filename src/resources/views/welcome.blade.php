    ...
    <div class="row " id="cv-section">
        ...
        <div class="col-md-6 d-flex align-items-center ">
            <h1 style="font-size: 5rem;line-height: 1.5;">
                ...
                <br>
                <a class="btn btn-outline-dark btn-lg text-center" href="https://gofile.io/d/HnUwe8" style="width: 30%;font-size: 2.2rem" role="button" download="Farzam CV">  Download </a>
            </h1>
